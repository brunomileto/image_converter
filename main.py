...
def converter():
    ...
    """
    TODO: Organize the function
    TODO: Create an GUI
    TODO: Make a better way for the use to input the folders names
    TODO: Make a better way for the use to input the type of the images
    TODO: Is there a way to get the type of the input images automatically?
    :return:
    """
    ...
    for file in glob.glob(
            input_folder + '*.' + input_image_type):  # glob will get the path of each file that matches the
        # rule inside ()
        img = Image.open(file)
